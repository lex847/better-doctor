export class doctorAPI {
  ...
  getDoctor(medicalIssue, displayDoctors) {
    ...
    $.get(`https://api.betterdoctor.com/2016-03-01/doctors?query=${medicalIssue}&user_location=45.523%2C-122.676&skip=0&limit=10&user_key=${apiKey}`).then(function(response) {
